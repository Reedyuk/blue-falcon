...
mavenPublishing {
    ...
    coordinates(
        ...
        artifactId = "blue-falcon-plugin-bonding",
        version = versionPlugins
    )
    
    pom {
        name.set("Blue Falcon Bonding Plugin")
        description.set("Bonding/pairing plugin for Blue Falcon - Observable, typed bonding workflow for BLE peripherals")
