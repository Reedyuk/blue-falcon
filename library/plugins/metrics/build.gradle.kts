...
mavenPublishing {
    ...
    coordinates(
        ...
        artifactId = "blue-falcon-plugin-metrics",
        version = versionPlugins
    )
    
    pom {
        name.set("Blue Falcon Metrics Plugin")
        description.set("Metrics/observability plugin for Blue Falcon - connection success rates, operation latency histograms, and read/write throughput for BLE operations")
