...
android {
    compileSdk = 33
    namespace = "dev.bluefalcon.plugins.queue"
    defaultConfig {
        minSdk = 24
        targetSdk = 33
    }
...
mavenPublishing {
    ...
    coordinates(
        ...
        artifactId = "blue-falcon-plugin-queue",
        version = versionPlugins,
    )

    pom {
        name.set("Blue Falcon Peripheral Queue Plugin")
        description.set("Bounded and fair notification queue for Blue Falcon peripheral sessions")
