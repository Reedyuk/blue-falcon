...
mavenPublishing {
    ...
    coordinates(
        ...
        artifactId = "blue-falcon-plugin-clone",
        version = versionPlugins
    )
    
    pom {
        name.set("Blue Falcon Clone Plugin")
        description.set("BLE device cloning plugin for Blue Falcon - Capture full device profiles including advertisement data, services, characteristics, and descriptors")
