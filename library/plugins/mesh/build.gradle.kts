    ...
    sourceSets {
        val commonMain by getting {
            dependencies {
                ...
                implementation(project(":peripheral"))
...
mavenPublishing {
    ...
    coordinates(
        ...
        artifactId = "blue-falcon-plugin-mesh",
        version = versionPlugins
    )
    
    pom {
        name.set("Blue Falcon Mesh Plugin")
        description.set("Mesh/Multi-Hop Relay plugin for Blue Falcon - enables BLE mesh networking with flood-with-dedup relay strategy")
