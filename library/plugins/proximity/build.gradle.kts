...
mavenPublishing {
    ...
    coordinates(
        ...
        artifactId = "blue-falcon-plugin-proximity",
        version = versionPlugins
    )
    
    pom {
        name.set("Blue Falcon Proximity Plugin")
        description.set("Proximity plugin for Blue Falcon - RSSI smoothing, proximity zones, and distance estimation for BLE devices")
