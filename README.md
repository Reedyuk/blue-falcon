# ![Blue Falcon](bluefalcon.png) Blue-Falcon ![CI](https://github.com/Reedyuk/blue-falcon/workflows/CI/badge.svg) [![Kotlin](https://img.shields.io/badge/kotlin-1.6.0-blue.svg)](http://kotlinlang.org) ![badge][badge-android] ![badge][badge-native] ![badge][badge-mac] ![badge][badge-rpi] ![badge][badge-js]
...
```kotlin
implementation 'dev.bluefalcon:blue-falcon-android:0.10.0'
```

And if you are using the debug variant:

```kotlin
implementation 'dev.bluefalcon:blue-falcon-android-debug:0.10.0'
```
...
```kotlin
implementation 'dev.bluefalcon:blue-falcon-rpi:0.10.0'
```
...
```kotlin
implementation 'dev.bluefalcon:blue-falcon:0.10.0'
```
